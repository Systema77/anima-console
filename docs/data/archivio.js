  ...
  "voci": [
    {
      ...
      "colore": "giallo",
      "data": "2026-09-14",
      "sintesi": "RISPOSTA SECCA ALLA DOMANDA: no, l'elenco non è completo, e manca soprattutto una CATEGORIA, non solo dei nomi.\n\nChi manca fra chi costruisce i modelli: xAI (di Elon Musk: 20 miliardi raccolti a gennaio 2026 a una valutazione intorno ai 230 miliardi, con NVIDIA e Cisco fra gli investitori); Mistral AI, il campione europeo, che a settembre 2026 ha chiuso il più grande round azionario mai fatto da una società tecnologica europea — circa 3 miliardi di euro guidati da Samsung, valutazione oltre 21 miliardi di euro; Microsoft e Amazon, che nell'elenco non compaiono ma sono decisive per una ragione doppia (sono i maggiori azionisti-fornitori dei laboratori indipendenti E hanno modelli propri); e i grandi cinesi oltre DeepSeek — Alibaba, ByteDance, Baidu, Tencent, Moonshot — che nell'elenco non ci sono affatto.\n\nMa la categoria davvero assente è CHI FA FUNZIONARE LA COSA: i produttori di silicio e di infrastruttura, senza cui nessuno dei sei esiste. TSMC fabbrica materialmente i chip; ASML è l'unica al mondo a costruire le macchine litografiche più avanzate; AMD e Broadcom sono le alternative a NVIDIA; Oracle, CoreWeave e SoftBank costruiscono e finanziano i centri dati. Chi ragiona sui «player dell'IA» guardando solo chi fa i modelli, guarda la punta e non la leva.\n\nCOME INTERAGISCONO — e qui sta il fatto più importante di tutta questa serie: NON sono sei concorrenti separati. Sono un intreccio in cui gli stessi soggetti sono contemporaneamente investitore, fornitore e concorrente l'uno dell'altro. Microsoft ha circa il 27% di OpenAI ed è fra i finanziatori di Anthropic. Amazon investe in Anthropic, la ospita, e ha messo 50 miliardi nel round OpenAI di febbraio 2026. Google finanzia Anthropic e insieme le fa concorrenza con Gemini. NVIDIA vende i chip a tutti e ha investito oltre 40 miliardi nei propri clienti, xAI compresa. La stampa finanziaria chiama questa struttura «finanziamento circolare» e ne discute apertamente il rischio: quando il fornitore finanzia il cliente che compra i suoi prodotti, dall'esterno diventa difficile dire quanta domanda sia autonoma. Non è un'accusa: è la forma degli accordi, ed è documentata.\n\nGLI STATI RISPETTO AI PRIVATI. Il divario di scala è netto e va detto con i numeri. Solo quattro aziende private (Microsoft, Meta, Alphabet, Amazon) hanno programmato per il 2026 oltre 470 miliardi di dollari di investimenti in conto capitale. L'Unione Europea, sul fronte pubblico, ha messo in campo un pacchetto per la sovranità tecnologica (giugno 2026) e una gara per un massimo di sette «gigafabbriche dell'IA» con oltre 30 miliardi di euro di investimento: un ordine di grandezza sotto. La leva europea, semmai, è normativa: dal 2 agosto 2026 la Commissione ha iniziato ad applicare le regole del regolamento sull'IA, con le modifiche dell'«omnibus» adottate a giugno 2026 ed entrate in vigore il 27 luglio 2026. La stessa Commissione dichiara che l'UE dipende da fuori per oltre l'80% di prodotti, servizi, infrastrutture e proprietà intellettuale digitali chiave. Sul versante cinese, il segnale misurabile è che i fondi di indirizzo di governi locali stanno entrando nel capitale privato (il caso DeepSeek). Sul versante statunitense esiste il progetto Stargate come impresa comune fra OpenAI, Oracle e SoftBank: è un'iniziativa privata annunciata in cornice politica, non un programma pubblico finanziato dallo Stato, e vanno tenute distinte.\n\nGLI ALTRI STATI — secondo giro, 14 settembre 2026. Il buco dichiarato al primo giro è ora coperto per sette giurisdizioni. Due cose contano più delle cifre.\n\nPRIMA: ANNUNCIATO NON È SPESO. L'India è il solo caso in cui il divario è pubblico e misurabile: la missione IndiaAI ha una dotazione approvata di 10.372 crore di rupie su cinque anni, ma nel 2024-25 risultano erogati 21,79 crore contro una previsione riveduta di 173, e nel 2025-26 379,15 crore contro 800. Chi mette in fila «programmi pubblici» e «spesa privata» quasi sempre sta confrontando un annuncio con una fattura. Per gli altri sei paesi il dato di erogazione effettiva non l'ho trovato: non vuol dire che il divario non ci sia.\n\nSECONDA: NEL GOLFO LO STATO NON È L'ALTERNATIVA AL PRIVATO, NE È L'INVESTITORE. MGX — creata a marzo 2024 da Mubadala, G42 e il consiglio statale emiratino per l'IA — punta a 100 miliardi di dollari di attivi; HUMAIN è interamente del fondo sovrano saudita PIF. Questo denaro pubblico non finanzia un'alternativa pubblica: compra dentro la stessa filiera privata. Stargate UAE si costruisce con OpenAI, Oracle, NVIDIA, Cisco e SoftBank. Contare queste cifre come «spesa pubblica contrapposta ai privati» è un errore di categoria, e va detto prima dei numeri.\n\nPaese per paese, con quel che ho potuto verificare:\n\n• STATI UNITI — Genesis Mission, nata da un ordine esecutivo del novembre 2025; il 22 luglio 2026 la Casa Bianca annuncia oltre 5 miliardi di dollari di impegni federali, il Dipartimento dell'Energia seleziona i primi 278 progetti (87 dei laboratori nazionali, 168 di università, 19 di imprese, 4 di enti non profit) e più di 15 agenzie si allineano su cinque sfide nazionali. È denaro pubblico vero, ma è IA per la scienza — non calcolo commerciale di frontiera.\n\n• CINA — fondo nazionale per l'industria dell'IA da 60,06 miliardi di yuan (circa 8,2 miliardi di dollari), istituito dal Ministero dell'Industria e dell'Informatica insieme al Ministero delle Finanze, con orizzonte dichiarato di 13 anni e il «Grande Fondo» dei semiconduttori fase III come unico sottoscrittore. La cifra è concorde su più fonti; la data no (vedi red flags). Il segnale già registrato al primo giro — fondi di indirizzo pubblici che entrano nel capitale privato — è quindi strutturale, non episodico.\n\n• REGNO UNITO — 1 miliardo di sterline sul calcolo pubblico, con l'obiettivo dichiarato di moltiplicarlo per venti in cinque anni; fino a 250 milioni per la capacità cloud della risorsa di ricerca sull'IA; fino a 500 milioni per l'unità sovrana per l'IA. Accanto, oltre 25 miliardi di sterline di investimenti privati annunciati su nuovi centri dati.\n\n• GIAPPONE — il più grosso impegno pubblico dichiarato del gruppo. Bilancio del ministero dell'economia per l'esercizio 2026 intorno a 3,07 trilioni di yen, di cui circa 1,23 trilioni destinati a semiconduttori e IA: dentro, 150 miliardi a Rapidus e 387,3 miliardi allo sviluppo nazionale dell'IA. La cornice pluriennale dichiarata è di oltre 10 trilioni di yen di sostegno pubblico in sette anni fino all'esercizio 2030, riportata in inglese come «65 miliardi di dollari».\n\n• INDIA — 10.372 crore di rupie di dotazione; oltre 38.000 GPU già messe a disposizione di startup e università tramite il portale pubblico, con obiettivo 100.000 entro dicembre 2026. E il divario di erogazione detto sopra.\n\n• EMIRATI ARABI UNITI — Stargate UAE, campus da 5 gigawatt ad Abu Dhabi annunciato a maggio 2025 con OpenAI, Oracle, NVIDIA, Cisco e SoftBank; prima tranche da 200 megawatt attesa nel 2026. Microsoft dichiara ulteriori 7,9 miliardi di dollari fra il 2026 e la fine del 2029, portando il totale nel paese a 15,2 miliardi.\n\n• ARABIA SAUDITA — HUMAIN, interamente del PIF, nata a maggio 2025; gara per un campus da 6 gigawatt a est di Riad; obiettivo 1,9 gigawatt di capacità entro il 2030 e oltre 6 entro il 2034; joint venture con l'operatore telefonico nazionale (51% HUMAIN, 49% stc). A settembre 2026 sta raccogliendo 2,5 miliardi di dollari per un fondo dedicato ai centri dati: che una società di un fondo sovrano da oltre 900 miliardi debba cercare capitale esterno è essa stessa un'informazione.\n\nLA RISPOSTA ALLA DOMANDA DEL DIRETTORE. Gli Stati non stanno correndo la stessa gara dei privati, e non perché siano indietro: perché giocano un altro ruolo. Preso da solo, nessuno di questi programmi pubblici arriva a un decimo dei 470 miliardi di dollari che quattro sole aziende private hanno programmato per il 2026. Ma il confronto per importi è quello sbagliato. L'Europa REGOLA (e dichiara di dipendere da fuori per oltre l'80% del digitale chiave). Il Golfo COMPRA dentro la filiera privata, con soldi sovrani. Stati Uniti, Giappone e Cina FINANZIANO la ricerca e la fabbrica di chip, cioè il piano sotto ai modelli. Nessuno Stato, in nessuna delle sette giurisdizioni verificate, sta costruendo in proprio calcolo di frontiera alla scala dei privati. Chi cerca «lo Stato concorrente di OpenAI» sta cercando una cosa che al settembre 2026 non esiste.\n\n⚠️ LIMITE, ORA PIÙ STRETTO: il buco del primo giro è colmato, ma a uno standard più debole del resto del verdetto. Nessuna delle fonti nuove è stata APERTA: in questa sessione la rete del contenitore blocca l'apertura diretta di TUTTI i domini provati — whitehouse.gov, gov.uk, digital-strategy.ec.europa.eu, brookings.edu e persino wikipedia.org, cinque su cinque. La ricerca per indice funziona, l'apertura no. Quel che segue sono URL reali con titolo e data corrispondenti, incrociati fra loro; dove una cifra sta in una fonte sola o solo in aggregatori, è detto nelle red flags. Resta scoperto il dato di erogazione effettiva per sei paesi su sette.",
      "scheda": null,
      "fonti": [
        {
        ...
        {
          "titolo": "Trump Administration Announces More Than $5 Billion for the Genesis Mission, a National Mission on AI for Science — La Casa Bianca, 22 luglio 2026",
          "url": "https://www.whitehouse.gov/releases/2026/07/45502/",
          "tipo": "comunicazione ufficiale di governo",
          "sostiene": "L'importo, la data e il perimetro del principale programma pubblico statunitense: oltre 5 miliardi di dollari, 278 progetti, più di 15 agenzie.",
          "autorevolezza": "alta — fonte primaria, ma non aperta da me"
        },
        {
          "titolo": "AI.gov — President Trump's AI Strategy and Action Plan",
          "url": "https://www.ai.gov/",
          "tipo": "sito ufficiale di governo",
          "sostiene": "L'esistenza e l'impianto del piano d'azione federale sull'IA, consultabile direttamente dal lettore.",
          "autorevolezza": "alta — fonte primaria, ma non aperta da me"
        },
        {
          "titolo": "Where does federal AI spending stand in 2026? — Brookings",
          "url": "https://www.brookings.edu/articles/where-does-federal-ai-spending-stand-in-2026/",
          "tipo": "centro studi indipendente",
          "sostiene": "La scala della spesa federale statunitense in contratti sull'IA. ⚠️ Le cifre di crescita dei contratti (da 4,6 a 91,8 miliardi di valore potenziale) le ho viste solo qui: fonte sola.",
          "autorevolezza": "media — fonte sola per quelle cifre"
        },
        {
          "titolo": "China sets up 60b yuan national AI fund to accelerate tech innovation — China Daily",
          "url": "https://www.chinadaily.com.cn/a/202504/18/WS6802358ea3104d9fd38204b5.html",
          "tipo": "stampa di Stato cinese",
          "sostiene": "L'istituzione e l'importo del fondo nazionale cinese per l'industria dell'IA.",
          "autorevolezza": "media — parte in causa, ma concorde con fonti terze sulla cifra"
        },
        {
          "titolo": "New AI fund in China to pour US$8 billion into early-stage projects — South China Morning Post",
          "url": "https://www.scmp.com/tech/policy/article/3306047/new-ai-fund-china-pour-us8-billion-early-stage-projects",
          "tipo": "stampa indipendente",
          "sostiene": "La stessa cifra letta in dollari (circa 8,2 miliardi), i ministeri promotori e l'orizzonte di 13 anni.",
          "autorevolezza": "alta"
        },
        {
          "titolo": "Full Stack: China's Evolving Industrial Policy for AI — RAND",
          "url": "https://www.rand.org/pubs/perspectives/PEA4012-1.html",
          "tipo": "centro studi indipendente",
          "sostiene": "L'impianto complessivo della politica industriale cinese sull'IA, oltre il singolo fondo.",
          "autorevolezza": "alta"
        },
        {
          "titolo": "AI to power national renewal as government announces billions of additional investment — GOV.UK",
          ...
          "tipo": "comunicazione ufficiale di governo",
          "sostiene": "Gli importi britannici sul calcolo pubblico e l'unità sovrana per l'IA.",
          "autorevolezza": "alta — fonte primaria, ma non aperta da me"
        },
        {
          "titolo": "AI Opportunities Action Plan — Government Response (CP 1242)",
          ...
          "tipo": "documento ufficiale di governo",
          "sostiene": "Il piano britannico nella sua forma depositata, con gli impegni presi punto per punto.",
          "autorevolezza": "alta — fonte primaria, ma non aperta da me"
        },
        {
          "titolo": "AI Opportunities Action Plan — 2026 Progress (delivery.ai.gov.uk)",
          "url": "https://delivery.ai.gov.uk/",
          "tipo": "cruscotto ufficiale di governo",
          "sostiene": "L'avanzamento dichiarato del piano britannico, compreso il percorso di capacità di calcolo.",
          "autorevolezza": "alta — fonte primaria, ma non aperta da me"
        },
        {
          "titolo": "METI budget hike lifts Japan chip and AI funding for FY 2026 — eeNews Europe",
          "url": "https://www.eenewseurope.com/en/meti-budget-hike-japan-chip-ai-fy-2026/",
          "tipo": "stampa di settore",
          "sostiene": "La ripartizione del bilancio giapponese: 3,07 trilioni di yen complessivi, 1,23 per semiconduttori e IA, 150 miliardi a Rapidus, 387,3 allo sviluppo nazionale dell'IA.",
          "autorevolezza": "media-alta"
        },
        {
          "titolo": "Japan commits to invest $65 billion in semiconductor and AI sector — S&P Global",
          "url": "https://autotechinsight.spglobal.com/news/5279004/japan-commits-to-invest-65-billion-in-semiconductor-and-ai-sector",
          "tipo": "stampa finanziaria indipendente",
          "sostiene": "La cornice pluriennale giapponese letta in dollari: è la fonte da cui viene l'equivalenza con i 10 trilioni di yen, non un mio calcolo.",
          "autorevolezza": "alta"
        },
        {
          "titolo": "IndiaAI Mission Expands AI Ecosystem with Affordable Compute and Startup Support — Press Information Bureau, Governo dell'India",
          "url": "https://www.pib.gov.in/PressReleasePage.aspx?PRID=2245069&reg=3&lang=1",
          "tipo": "comunicazione ufficiale di governo",
          "sostiene": "La dotazione di 10.372 crore di rupie e le oltre 38.000 GPU messe a disposizione.",
          "autorevolezza": "alta — fonte primaria, ma non aperta da me"
        },
        {
          "titolo": "The United Arab Emirates' AI Ambitions — CSIS",
          "url": "https://www.csis.org/analysis/united-arab-emirates-ai-ambitions",
          "tipo": "centro studi indipendente",
          "sostiene": "L'impianto della strategia emiratina, la nascita di MGX (marzo 2024) e il ruolo del consiglio statale per l'IA.",
          "autorevolezza": "alta"
        },
        {
          "titolo": "Introducing Stargate UAE — OpenAI",
          "url": "https://openai.com/index/introducing-stargate-uae/",
          "tipo": "dichiarazione della società",
          "sostiene": "Scala, partner e fasi del campus di Abu Dhabi. ⚠️ Parte in causa: OpenAI è uno dei costruttori.",
          "autorevolezza": "media — parte in causa"
        },
        {
          "titolo": "HUMAIN — Public Investment Fund (PIF), Arabia Saudita",
          "url": "https://www.pif.gov.sa/en/our-investments/our-portfolio/humain/",
          "tipo": "comunicazione ufficiale del fondo sovrano",
          "sostiene": "Che HUMAIN sia interamente del PIF: il fatto che regge l'intera lettura del caso saudita.",
          "autorevolezza": "alta — fonte primaria, ma non aperta da me"
        },
        {
          "titolo": "Saudi AI giant races to fund data center expansion — Fortune, 9 settembre 2026",
          "url": "https://fortune.com/2026/09/09/saudis-humain-turns-to-outside-investment-as-the-kingdom-reins-in-fiscal-spending/",
          "tipo": "stampa finanziaria indipendente",
          "sostiene": "Che HUMAIN stia cercando capitale esterno mentre il Regno frena la spesa pubblica: il contrappeso alle cifre d'annuncio.",
          "autorevolezza": "alta"
        }
      ],
      ...
      "green_flags": [
        ...
        "Sui programmi pubblici esistono documenti ufficiali che il lettore può aprire da sé anche dove io non ho potuto: Casa Bianca e ai.gov per gli Stati Uniti, gov.uk e il cruscotto delivery.ai.gov.uk per il Regno Unito, il Press Information Bureau per l'India, pif.gov.sa per l'Arabia Saudita. Il controllo non dipende dalla mia parola."
      ],
      "red_flags": [
        "Il buco sugli Stati è colmato per sette giurisdizioni, ma a uno standard più debole del resto del verdetto: nessuna fonte nuova è stata aperta. In questa sessione l'apertura diretta è fallita su cinque domini su cinque provati, whitehouse.gov e wikipedia.org compresi. Sono titoli, URL e riassunti d'indice, incrociati fra loro.",
        "Sul fondo cinese da 60,06 miliardi di yuan le fonti concordano sulla CIFRA e non sulla DATA: gennaio 2025, aprile 2025 e febbraio 2026 compaiono in fonti diverse per quello che sembra lo stesso fondo. La cifra è usabile, la data no — e chi la cita come «nuova del 2026» sta probabilmente ripetendo un aggregatore.",
        "Annunciato non è speso, ed è il vizio che rende quasi tutti questi numeri pubblici non confrontabili con la spesa privata. L'India è l'unico caso in cui il divario è pubblico: 379,15 crore erogati contro 800 previsti nel 2025-26, su una dotazione di 10.372. Per gli altri sei paesi il dato di erogazione non l'ho trovato.",
        "Le cifre del Golfo — 100 miliardi di dollari per MGX, 100 miliardi attribuiti a HUMAIN — sono obiettivi di raccolta dichiarati, non capitale versato, e circolano soprattutto in aggregatori e siti di settore. Vanno lette come ambizione dichiarata, non come bilancio.",
        "L'equivalenza fra i «oltre 10 trilioni di yen» giapponesi e i «65 miliardi di dollari» dei titoli in inglese è riportata dalle fonti, non calcolata qui: in questo verdetto non c'è nessuna conversione di valuta fatta da me.",
      ...
      "timeline": [
        ...
        {
          "data": "2026-07-22",
          "evento": "La Casa Bianca annuncia oltre 5 miliardi di dollari per la Genesis Mission; il Dipartimento dell'Energia seleziona 278 progetti e oltre 15 agenzie si allineano su cinque sfide nazionali."
        },
        {
          "data": "2026-07-27",
        ...
        {
          "data": "2026-09-04",
          "evento": "HUMAIN, società del fondo sovrano saudita PIF, risulta impegnata a raccogliere 2,5 miliardi di dollari per un fondo dedicato ai centri dati."
        },
        {
          "data": "2026-09-08",
        ...
        {
          "data": "2026-09-09",
          "evento": "Fortune riporta che HUMAIN cerca capitale esterno mentre il Regno frena la spesa pubblica: l'annuncio da 100 miliardi e la cassa non coincidono."
        }
      ],
      "nota_sicurezza": "Nessun link è stato aperto o eseguito: l'oggetto di questa verifica sono ditte, non un sito sospetto. ⚠️ LIMITE MISURATO IN QUESTA SESSIONE, non dedotto: il proxy di rete ha bloccato l'apertura diretta di TUTTI i domini delle fonti (openai.com, cnbc.com, sec.gov, anthropic.com, investor.nvidia.com, europa.eu — provati, errore EGRESS_BLOCKED / codice 000). Le fonti elencate sono URL reali restituiti dall'indice di ricerca con titolo e data corrispondenti, e sono cliccabili per il lettore, ma NON le ho aperte una per una: ho incrociato più risultati indipendenti. Dove una cifra compare in una fonte sola o solo in aggregatori, è detto nelle red flags. «Non ho potuto aprirlo» vale più di «dovrebbe funzionare». ⚠️ SECONDO GIRO, 14 settembre 2026 — rimisurato, non ricopiato: la ricerca per indice in questa sessione FUNZIONA (a differenza del primo giro), ma l'apertura diretta delle pagine è bloccata su CINQUE domini su cinque provati — whitehouse.gov, gov.uk, digital-strategy.ec.europa.eu, brookings.edu, en.wikipedia.org — con errore EGRESS_BLOCKED; curl dà codice 000 su tutti. Quindi la parte nuova sugli Stati sta allo stesso standard dichiarato della prima: fonti incrociate, mai aperte."
    },
    {
