...
Le regole complete stanno in **`CLAUDE.md`**, in questa cartella: leggilo prima di
toccare qualcosa.
...
funzionare». Le misure vere le fa il runner GitHub (Actions), non una sessione agente: da
qui la rete verso le nostre case risponde 403.
